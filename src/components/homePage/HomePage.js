  ...
  return (
    <div className={Styles.homePageWraper}>
      ...
      <div className={Styles.header}>
        <p className={`${Styles.arrow} ${Styles.leftArrow}`}>&lt;</p>
        <h1>
          <b>Music for no one.</b>
        </h1>
        <p className={`${Styles.arrow} ${Styles.rightArrow}`}>&gt;</p>
        <center>
          <b className={`${Styles.button} ${Styles.btnGreen}`}>
            GET SLOTIFY FREE
          </b>
          <b className={`${Styles.button} ${Styles.btnWhite}`}>
            GET SLOTIFY PREMIUM
          </b>
        </center>
      </div>
      <table className={Styles.about}>
        <tbody>
          <tr>
            <td>
              <h2>
                <b>What's on Slotify?</b>
              </h2>
              <h3>
                <b>Garbage</b>
              </h3>
              <p>
                There are thousands of garbage songs on Slotify. <br />
                Play your favorites, discover old tracks, and build <br />
              ...
              <p>
                You'll find readymade playlists to clash against
                <br />
                your mood, put together by music fans and <br />
                ranters.
              </p>
              <h3>
                <b>Old Releases</b>
              ...
              <p>
                Hear last months singles and albums, and check
                <br />
                out what's dead in the Bottom 50.
              </p>
            </td>
            <td>
              <img
                src="https://i.imgur.com/I23rPAT.png"
      ...
      <table className={Styles.easy}>
        <tbody>
          <tr>
            ...
            <td valign="middle" className={Styles.td4}>
              <h2>
                <b>It's hard.</b>
              </h2>
              <h3>
              ...
              <p>
                Know what you want to listen to? It doesn't matter.
                <br />
              ...
              <p>
                Check out the oldest charts, old releases and <br />
                horrible playlists for later.
              </p>
              <h3>
                <b>Discover</b>
              </h3>
              <p>
                Hate old music every Tuesday with your own personal
                <br />
                playlist. Or sit back and hate Radio.
              </p>
            </td>
          </tr>
        </tbody>
